...
export const exportSvg = defineTool({
  ...
  params: {
    ...
    path: {
      type: 'string',
      description: 'Write SVG to this path instead of returning it (requires NEXDESIGN_MCP_ROOT)'
    }
  },
...
export const exportPdf = defineTool({
  ...
  params: {
    ...
    path: {
      type: 'string',
      description:
        'Write PDF to this path instead of returning base64 (requires NEXDESIGN_MCP_ROOT)'
    }
  },
  execute: async (figma, args) => {
...
export const exportImage = defineTool({
  ...
  params: {
    ...
    path: {
      type: 'string',
      description:
        'Write image to this path instead of returning base64 (requires NEXDESIGN_MCP_ROOT)'
    }
  },
  execute: async (figma, args) => {
