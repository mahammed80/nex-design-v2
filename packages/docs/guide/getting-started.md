...
NexDesign runs in the browser — no installation required. Open [app.nexdesign.dev](https://app.nexdesign.dev) to start designing.
...
Pre-built binaries for macOS, Windows, and Linux are available on the [releases page](https://github.com/nex-design/nex-design/releases/latest).
