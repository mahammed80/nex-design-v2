...
description: Folder structure, public API boundaries, and composition patterns in @nex-design/vue.
---

# SDK Architecture

`@nex-design/vue` is the Vue-facing layer over `@nex-design/core`.
...
If a piece of logic could be reused in a different NexDesign-based app without bringing app styling with it, it probably belongs in `@nex-design/vue`.
