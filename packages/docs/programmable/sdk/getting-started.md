...
description: Set up @nex-design/vue with createEditor, provideEditor, and a canvas.
---
...
The SDK lives in the monorepo today and is also published as `@nex-design/vue`.
...
1. `@nex-design/core` — framework-agnostic editor engine
2. `@nex-design/vue` — Vue composables and headless primitives
