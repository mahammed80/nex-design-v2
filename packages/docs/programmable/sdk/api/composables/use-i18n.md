---
title: useI18n
description: Read localized NexDesign UI messages and switch the active SDK locale.
---

# useI18n

`useI18n()` returns reactive translation groups plus locale controls for NexDesign-powered editor shells.
