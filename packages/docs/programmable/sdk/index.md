---
title: Vue SDK
description: Build NexDesign-powered editors with headless Vue composables and primitives.
---

# Vue SDK

`@nex-design/vue` exists so NexDesign can be more than a standalone design app.

The goal is to make NexDesign a toolkit you can embed into other products, internal tools, and workflow-specific editors — not just a single default UI.

The NexDesign app is one composition of that toolkit. The SDK is how you build a different one.
...
- **Framework-aware**: Vue integration over `@nex-design/core`
