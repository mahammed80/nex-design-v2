...
A typical NexDesign Vue app has three layers:

1. `@nex-design/core` creates the editor
2. `@nex-design/vue` adapts it into Vue composables and headless primitives
3. your app renders the shell, styling, and product UX

## Why this matters

The built-in NexDesign app is only one possible shell.
