...
Yoga di Meta fornisce il calcolo del layout CSS flexbox e grid tramite un [fork](https://github.com/nex-design/yoga/tree/grid) con supporto CSS Grid. Un adattatore sottile mappa i nomi delle proprietà Figma agli equivalenti Yoga:
