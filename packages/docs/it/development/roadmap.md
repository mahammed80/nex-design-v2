...
**Consegnato:**
- @nex-design/core estratto in packages/core/ (nessuna dipendenza DOM)
- @nex-design/cli con operazioni headless .fig (info, tree, find, export, analyze, eval)
...
- Server MCP (@nex-design/mcp): stdio + HTTP, 87 strumenti core + 3 gestione file
