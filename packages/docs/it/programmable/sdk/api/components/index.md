---
title: Componenti
description: Riferimento ai componenti per le primitive Vue headless in @nex-design/vue.
---

# Componenti

`@nex-design/vue` espone primitive strutturali headless per il cablaggio del canvas, UI di navigazione, pannelli proprietà e controlli di input mirati.
