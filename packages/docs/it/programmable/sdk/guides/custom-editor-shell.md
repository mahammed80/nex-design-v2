...
Una tipica app Vue con NexDesign ha tre livelli:

1. `@nex-design/core` crea l'editor
2. `@nex-design/vue` lo adatta in composable Vue e primitive headless
3. la tua app renderizza la shell, lo stile e la UX specifica del prodotto

## Perché questo è importante

L'app NexDesign integrata è solo una possibile shell.
