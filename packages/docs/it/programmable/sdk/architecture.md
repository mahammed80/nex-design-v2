...
description: Struttura delle cartelle, confini dell'API pubblica e pattern di composizione in @nex-design/vue.
---

# Architettura dell'SDK

`@nex-design/vue` è il livello Vue sopra `@nex-design/core`.
...
Se un pezzo di logica potrebbe essere riutilizzato in un'app diversa basata su NexDesign senza portare lo stile dell'app con sé, probabilmente appartiene a `@nex-design/vue`.
