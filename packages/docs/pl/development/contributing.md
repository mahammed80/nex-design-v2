...
```
packages/
  core/              @nex-design/core — silnik (zero zależności DOM)
    src/             Graf sceny, renderer, layout, kodek, kiwi, typy
  cli/               @nex-design/cli — headless CLI do operacji .fig
    src/commands/    info, tree, find, export, eval, analyze
  mcp/               @nex-design/mcp — serwer MCP dla narzędzi AI
...
src/
  ...
  engine/            Shimy re-eksportu z @nex-design/core
  kiwi/              Shimy re-eksportu z @nex-design/core
...
Deweloperzy i agenci AI powinni przeczytać `AGENTS.md` w katalogu głównym repo ([zobacz na GitHub](https://github.com/nex-design/nex-design/blob/master/AGENTS.md)). Obejmuje renderowanie, graf sceny, komponenty i instancje, layout, UI, format pliku, konwencje Tauri i znane problemy.
