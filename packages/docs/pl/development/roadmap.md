...
**Dostarczone:**
- @nex-design/core wyodrębniony do packages/core/ (zero zależności DOM)
- @nex-design/cli z headless operacjami .fig (info, tree, find, export, analyze, eval)
...
- Serwer MCP (@nex-design/mcp): stdio + HTTP, 87 narzędzi core + 3 zarządzanie plikami
