...
Porównanie funkcja po funkcji możliwości Figma Design z aktualnym stanem implementacji Nex Design.
...
| Serwer MCP | ✅ | @nex-design/mcp z transportami stdio + HTTP; 87 narzędzi core + 3 zarządzanie plikami = 90+ total |
