...
Typowa aplikacja Vue z NexDesign ma trzy warstwy:

1. `@nex-design/core` tworzy edytor
2. `@nex-design/vue` adaptuje go do kompozytów Vue i bezstanowych prymitywów
3. twoja aplikacja renderuje powłokę, stylowanie i UX specyficzny dla produktu

## Dlaczego to ważne

Wbudowana aplikacja NexDesign to tylko jedna możliwa powłoka.
