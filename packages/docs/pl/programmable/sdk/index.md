---
title: Vue SDK
description: Buduj edytory oparte na NexDesign z bezstanowymi kompozytami i prymitywami Vue.
---

# Vue SDK

`@nex-design/vue` istnieje po to, by NexDesign mógł być czymś więcej niż samodzielną aplikacją do projektowania.

Celem jest uczynienie NexDesign zestawem narzędzi, który można wbudować w inne produkty, narzędzia wewnętrzne i edytory dopasowane do konkretnych przepływów pracy — a nie tylko jednym domyślnym interfejsem.

Aplikacja NexDesign jest jedną z kompozycji tego zestawu. SDK to sposób na zbudowanie innej.
...
- **Świadomość frameworka**: integracja Vue nad `@nex-design/core`
