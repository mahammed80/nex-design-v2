---
title: Vue SDK
description: Créez des éditeurs propulsés par NexDesign avec des composables Vue headless et des primitives.
---

# Vue SDK

`@nex-design/vue` existe pour qu'NexDesign puisse être bien plus qu'une application de design autonome.

L'objectif est de faire d'NexDesign une boîte à outils intégrable dans d'autres produits, outils internes, et éditeurs spécialisés — pas seulement une interface par défaut.

L'application NexDesign est une composition de cette boîte à outils. Le SDK est la façon dont vous en construisez une différente.
...
- **Intégration framework** : intégration Vue au-dessus de `@nex-design/core`
