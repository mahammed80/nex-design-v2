...
description: Structure des dossiers, frontières d'API publique et patterns de composition dans @nex-design/vue.
---

# Architecture SDK

`@nex-design/vue` est la couche Vue au-dessus de `@nex-design/core`.
...
Si un morceau de logique pourrait être réutilisé dans une autre application basée sur NexDesign sans emporter les styles applicatifs, il appartient probablement à `@nex-design/vue`.
