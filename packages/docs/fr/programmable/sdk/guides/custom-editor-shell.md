...
Une application Vue NexDesign typique comporte trois couches :

1. `@nex-design/core` crée l'éditeur
2. `@nex-design/vue` l'adapte en composables Vue et primitives headless
3. votre application affiche le shell, les styles et l'UX du produit

## Pourquoi c'est important

L'application NexDesign intégrée n'est qu'un shell possible parmi d'autres.
