...
**Livré :**
- @nex-design/core extrait dans packages/core/ (aucune dépendance DOM)
- @nex-design/cli avec opérations headless .fig (info, tree, find, export, analyze, eval)
...
- Serveur MCP (@nex-design/mcp) : stdio + HTTP, 87 outils core + 3 gestion de fichiers
