...
```
packages/
  core/              @nex-design/core — moteur (zéro dépendance DOM)
    src/             Graphe de scène, renderer, layout, codec, kiwi, types
  cli/               @nex-design/cli — CLI headless pour opérations .fig
    src/commands/    info, tree, find, export, eval, analyze
  mcp/               @nex-design/mcp — serveur MCP pour outils IA
...
src/
  ...
  engine/            Shims de ré-exportation depuis @nex-design/core
  kiwi/              Shims de ré-exportation depuis @nex-design/core
...
Les développeurs et agents IA doivent lire `AGENTS.md` à la racine du repo ([voir sur GitHub](https://github.com/nex-design/nex-design/blob/master/AGENTS.md)). Couvre le rendu, le graphe de scène, les composants et instances, le layout, l'UI, le format de fichier, les conventions Tauri et les problèmes connus.
