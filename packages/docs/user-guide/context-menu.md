---
title: Context Menu
description: Right-click context menu actions in NexDesign — clipboard, z-order, grouping, components, and more.
---
...
- **Copy as JSX** — copies the NexDesign JSX representation for use with `renderJsx()`
