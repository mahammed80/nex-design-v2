...
layout: doc
title: User Guide
description: Learn how to use NexDesign — canvas navigation, drawing, text, components, auto-layout, and more.
---

# User Guide

NexDesign is an open-source, Figma-compatible design editor — fully local, AI-native, and programmable. This guide covers everything you need to know to use the editor effectively.
