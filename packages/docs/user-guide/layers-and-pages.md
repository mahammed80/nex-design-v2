---
title: Layers & Pages
description: Managing layers, pages, and the properties panel in NexDesign.
---
...
- **NexDesign JSX** — custom component tree compatible with `renderJsx()` for programmatic round-trip
