...
**Entregado:**
- @nex-design/core extraído a packages/core/ (sin dependencias DOM)
- @nex-design/cli con operaciones headless .fig (info, tree, find, export, analyze, eval)
...
- Servidor MCP (@nex-design/mcp): stdio + HTTP, 87 herramientas core + 3 de gestión de archivos
