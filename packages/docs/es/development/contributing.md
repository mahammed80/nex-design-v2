...
```
packages/
  core/              @nex-design/core — motor (sin deps DOM)
    src/             Grafo de escena, renderer, layout, codec, kiwi, tipos
  cli/               @nex-design/cli — CLI headless para operaciones .fig
    src/commands/    info, tree, find, export, eval, analyze
  mcp/               @nex-design/mcp — servidor MCP para herramientas IA
...
src/
  ...
  engine/            Shims de re-exportación desde @nex-design/core
  kiwi/              Shims de re-exportación desde @nex-design/core
...
Desarrolladores y agentes IA deben leer `AGENTS.md` en la raíz del repo ([ver en GitHub](https://github.com/nex-design/nex-design/blob/master/AGENTS.md)). Cubre renderizado, grafo de escena, componentes e instancias, layout, UI, formato de archivo, convenciones Tauri y problemas conocidos.
