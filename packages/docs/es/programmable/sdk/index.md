---
title: Vue SDK
description: Construye editores con NexDesign usando composables headless y primitivos de Vue.
---

# Vue SDK

`@nex-design/vue` existe para que NexDesign pueda ser más que una aplicación de diseño independiente.

El objetivo es convertir NexDesign en un toolkit que puedas integrar en otros productos, herramientas internas y editores específicos de flujo de trabajo — no solo una interfaz predeterminada.

La aplicación NexDesign es una composición de ese toolkit. El SDK es la forma en que construyes una diferente.
...
- **Integración con el framework**: integración de Vue sobre `@nex-design/core`
