...
Una app Vue típica de NexDesign tiene tres capas:

1. `@nex-design/core` crea el editor
2. `@nex-design/vue` lo adapta en composables de Vue y primitivos headless
3. tu app renderiza el shell, los estilos y la UX del producto

## Por qué esto importa

La app integrada de NexDesign es solo un shell posible.
