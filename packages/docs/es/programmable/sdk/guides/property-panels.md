...
Los paneles de propiedades en `@nex-design/vue` están diseñados de forma intencionalmente composable primero.
...
```vue
<script setup lang="ts">
import { PropertyListRoot, useFillControls } from '@nex-design/vue'
