---
title: Componentes
description: Referencia de componentes para los primitivos headless de Vue en @nex-design/vue.
---

# Componentes

`@nex-design/vue` expone primitivos estructurales headless para el cableado del canvas, la UI de navegación, los paneles de propiedades y los controles de entrada enfocados.
