...
description: Configura @nex-design/vue con createEditor, provideEditor y un canvas.
---
...
El SDK vive en el monorepo hoy en día y también se publica como `@nex-design/vue`.
...
1. `@nex-design/core` — motor del editor independiente del framework
2. `@nex-design/vue` — composables de Vue y primitivos headless
