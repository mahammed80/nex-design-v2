...
description: Estructura de carpetas, límites de API pública y patrones de composición en @nex-design/vue.
---

# Arquitectura del SDK

`@nex-design/vue` es la capa orientada a Vue sobre `@nex-design/core`.
...
Si una pieza de lógica podría reutilizarse en una app diferente basada en NexDesign sin llevar consigo los estilos de la app, probablemente pertenece a `@nex-design/vue`.
