...
**Geliefert:**
- @nex-design/core extrahiert in packages/core/ (keine DOM-Abhängigkeiten)
- @nex-design/cli mit headless .fig-Operationen (info, tree, find, export, analyze, node, pages, variables, eval)
...
- MCP-Server (@nex-design/mcp): stdio + HTTP, 87 Core-Tools + 3 Dateiverwaltungs-Tools
