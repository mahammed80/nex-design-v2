...
description: Ordnerstruktur, öffentliche API-Grenzen und Kompositionsmuster in @nex-design/vue.
---

# SDK-Architektur

`@nex-design/vue` ist die Vue-seitige Schicht über `@nex-design/core`.
...
Wenn ein Stück Logik in einer anderen NexDesign-basierten App wiederverwendet werden könnte, ohne App-Styling mitzubringen, gehört es wahrscheinlich in `@nex-design/vue`.
