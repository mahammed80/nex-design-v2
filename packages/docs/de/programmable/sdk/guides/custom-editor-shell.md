...
Eine typische NexDesign Vue-App hat drei Schichten:

1. `@nex-design/core` erstellt den Editor
2. `@nex-design/vue` passt ihn in Vue Composables und headless Primitive an
3. Ihre App rendert die Shell, das Styling und die produkt-spezifische UX

## Warum das wichtig ist

Die eingebaute NexDesign-App ist nur eine mögliche Shell.
