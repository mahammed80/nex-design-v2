---
title: useI18n
description: Lokalisierte NexDesign-UI-Nachrichten lesen und die aktive SDK-Locale wechseln.
---

# useI18n

`useI18n()` gibt reaktive Übersetzungsgruppen sowie Locale-Steuerelemente für NexDesign-gestützte Editor-Shells zurück.
