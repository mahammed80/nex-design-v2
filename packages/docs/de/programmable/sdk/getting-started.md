...
description: "@nex-design/vue mit createEditor, provideEditor und einem Canvas einrichten."
---
...
Das SDK befindet sich heute im Monorepo und wird auch als `@nex-design/vue` veröffentlicht.
...
1. `@nex-design/core` — framework-agnostische Editor-Engine
2. `@nex-design/vue` — Vue Composables und headless Primitive
