---
title: Vue SDK
description: Erstellen Sie NexDesign-gestützte Editoren mit headless Vue Composables und Primitiven.
---

# Vue SDK

`@nex-design/vue` gibt es, damit NexDesign mehr als eine eigenständige Design-App sein kann.

Das Ziel ist es, NexDesign zu einem Toolkit zu machen, das Sie in andere Produkte, interne Tools und workflow-spezifische Editoren einbetten können — nicht nur als einzelne Standard-UI.

Die NexDesign-App ist eine mögliche Zusammensetzung dieses Toolkits. Das SDK ist der Weg, eine andere zu bauen.
...
- **Framework-bewusst**: Vue-Integration über `@nex-design/core`
