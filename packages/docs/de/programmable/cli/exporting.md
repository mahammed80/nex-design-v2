...
```sh
nex-design export design.fig                          # PNG (Standard)
nex-design export design.fig -f jpg -s 2 -q 90       # JPG in 2×, Qualität 90
nex-design export design.fig -f webp -s 3             # WEBP in 3×
nex-design export design.fig -f svg                   # SVG-Vektor
```
...
Unterstützt auch `--style nexdesign` für das native JSX-Format (siehe [JSX-Renderer](../jsx-renderer)).
...
```sh
nex-design export -f png    # Screenshot der aktuellen Zeichenfläche
```
