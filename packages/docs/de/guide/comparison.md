...
NexDesign und Penpot sind beides Open-Source-Design-Tools, aber sie unterscheiden sich grundlegend in Architektur, Rendering und Dateiformaten.

## 1. Auf einen Blick

| Metrik | Nex Design | Penpot |
|--------|-------------|--------|
...
Nex Design ist **~11× kleiner** — und das ist der Punkt. Es ist keine Vereinfachung; es ist eine grundlegend andere Architektur.
...
Nex Design und Penpot verwenden beide Skia für das Rendering, aber die Implementierungen unterscheiden sich:

- **Nex Design**: CanvasKit WASM — bewährt, GPU-beschleunigt, dieselbe Engine wie Figma
...
|--------|----------|-------|
| **Figma-Kompatibilität** | Nex Design | Natives .fig + Zwischenablage |
| **Programmierbarkeit** | Nex Design | CLI, eval, JSX, MCP-Server |
| **Desktop-Erlebnis** | Nex Design | Native Tauri-App, ~5 MB |
| **KI-Integration** | Nex Design | 90 Werkzeuge, MCP, integrierter Chat |
| **Codebasis-Einfachheit** | Nex Design | 11× weniger Code, 1 Sprache |
