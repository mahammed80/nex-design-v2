...
- Идентичность приложения: иконка-карандаш, Cargo crate nex_design, macOS Dock «NexDesign»
...
**Реализовано:**
- @nex-design/core извлечён в packages/core/ (без DOM-зависимостей, Bun workspace)
- @nex-design/cli с headless-операциями над .fig (info, tree, find, export, analyze, node, pages, variables, eval), CPU-растеризация CanvasKit, вывод --json
...
- MCP-сервер (@nex-design/mcp): stdio + HTTP (Hono + Streamable HTTP с сессиями), 87 core-инструментов + 3 инструмента управления файлами (90 всего), работает на Bun и Node.js
...
- Сайт документации VitePress на nexdesign.dev с i18n (6 языков)
