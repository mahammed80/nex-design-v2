...
```
packages/
  core/              @nex-design/core — движок (без DOM-зависимостей)
    src/             Граф сцены, отрисовщик, компоновка, кодек, kiwi, типы
  cli/               @nex-design/cli — headless CLI для операций с .fig
    src/commands/    info, tree, find, export, eval, analyze
  mcp/               @nex-design/mcp — MCP-сервер для AI-инструментов
...
src/
  ...
  engine/            Шимы реэкспорта из @nex-design/core
  kiwi/              Шимы реэкспорта из @nex-design/core
