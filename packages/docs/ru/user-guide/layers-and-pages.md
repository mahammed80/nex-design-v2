...
description: Управление слоями, страницами и панелью свойств в NexDesign.
---
...
- **NexDesign JSX** — дерево компонентов, совместимое с `renderJsx()` для программного двустороннего преобразования
