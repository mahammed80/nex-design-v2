...
description: Настройка @nex-design/vue с createEditor, provideEditor и холстом.
---
...
SDK находится в монорепозитории и также опубликован как `@nex-design/vue`.
...
1. `@nex-design/core` — не зависящий от фреймворка движок редактора
2. `@nex-design/vue` — Vue-компосаблы и headless-примитивы
