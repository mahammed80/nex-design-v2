---
title: useI18n
description: Чтение локализованных сообщений интерфейса NexDesign и переключение активной локали SDK.
---

# useI18n

`useI18n()` возвращает реактивные группы переводов и элементы управления локалью для оболочек редактора на базе NexDesign.
