---
title: Компоненты
description: Справочник компонентов — headless-примитивы Vue в @nex-design/vue.
---

# Компоненты

`@nex-design/vue` предоставляет headless-структурные примитивы для подключения холста, навигационного UI, панелей свойств и специализированных элементов ввода.
