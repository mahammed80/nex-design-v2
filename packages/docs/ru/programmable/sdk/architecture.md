...
description: Структура папок, границы публичного API и паттерны компоновки в @nex-design/vue.
---

# Архитектура SDK

`@nex-design/vue` — Vue-слой поверх `@nex-design/core`.
...
Если кусок логики можно переиспользовать в другом приложении на базе NexDesign без привнесения стилей — скорее всего, ему место в `@nex-design/vue`.
